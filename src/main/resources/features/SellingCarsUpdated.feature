Feature: Customer wants to verify an offer to sell his car
  ...
  Scenario Outline: To fetch all car brands available in Europe
    ...
    Examples:
      ...
      | /v1/car-types/manufacturer | /v1/car-types/main-types | /v1/car-types/built-dates | fr_FR  |           |
      | /v1/car-types/manufacturer | /v1/car-types/main-types | /v1/car-types/built-dates | es_ES  |           |
      | /v1/car-types/manufacturer | /v1/car-types/main-types | /v1/car-types/built-dates | de_DE  |           |
